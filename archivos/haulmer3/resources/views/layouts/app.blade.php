...
<body class ="bg-gray-100 text-gray-800">
    ...
    <nav class= "flex py-5 bg-blue-500 text-white">
        ...
        <div class="w-1/2 px-12 mr-auto"> 
            ...
            <p class="text-2xl font-bold"> Haulmer</p>
        </div>
        ...
        <ul class =" w-1/2 px-16 ml-auto flex justify-end pt-1">
            ...
            <li>
                <a href="{{ route ('new.index')}}"class = "fond-semibold border-2 border-white py-2 px-4 rounded-md hover:bg-white hover:text-indigo-700">New</a>
            </li>
        </ul>
